...
const {
  deleteRealStateHandler,
} = require("../handlers/deleteRealStateHandler");
...
} = require("../handlers/getExcelRealStateHandler");
...
} = require("../handlers/getAllAppraisalsHandler");
const { getAllTagsHandler } = require("../handlers/getAllTagsHandler");
const {
  getTestimonialsHandler,
} = require("../handlers/getTestimonialsHandler");
const {
  postTestimonialHandler,
} = require("../handlers/postTestimonialHandler");
const {
  putTestimonialsHandler,
} = require("../handlers/putTestimonialsHandler");
...
router.put("/testimonials/:id", putTestimonialsHandler);
