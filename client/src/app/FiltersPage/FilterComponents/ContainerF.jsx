    ...
    <div className="flex flex-col bg-gray text-center ">
      <div className="flex justify-center p-4 m-2 space-x-4">
        ...
        <select
          ...
          className="border text-sm text-black rounded-lg w-40"
        >
        ...
        <select
          ...
          onChange={handleChange}
          class="border text-sm text-black rounded-lg w-40"
        >
        ...
        <button
          className="rounded-full bg-white text-black w-48 uppercase font-bold"
          onClick={handleClick}
        >
          Realizar filtro
        </button>
        ...
        <div className="w-1/3 bg-gray-500">
          <div class=" px-4 py-6">
            <div className="flex flex-row m-4">
              <label htmlFor="" className="ml-5 mr-5">
                Baños
              </label>
              <input
            ...
            <h3 class="bg-white text-black">Servicios</h3>

            <div className="grid grid-cols-3 justify-center">
              {tipe1.map((services) => (
                <label key={services} className={style.checkboxes}>
                  <input type="checkbox" name="tags" value={filters.tags} />
          ...
          <div class=" px-4 py-6">
            <h3 class="bg-white text-black">Ambientes</h3>

            <div className="grid grid-cols-3 justify-center">
              {tipe2.map((ambient) => (
                <label key={ambient} className={style.checkboxes}>
                  <input type="checkbox" name="ambient" value={ambient} />
                  <span className={style.checkboxText}>
          ...
          <div class=" px-4 py-6">
            <h3 class="bg-white text-black">Adicionales</h3>

            <div className="grid grid-cols-3 justify-center">
              {tipe3.map((addons) => (
                <label key={addons} className={style.checkboxes}>
                  <input type="checkbox" name="ambient" value={addons} />
                  <span className={style.checkboxText}>
