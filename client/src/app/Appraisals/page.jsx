...
export default function Example() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      await axios.post("https://bienesraices-production-9eb3.up.railway.app/appraisals", {
        ...formData,
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div class=" min-h-screen flex items-center justify-center bg-center py-12 px-4 sm:px-6 lg:px-8 bg-white bg-no-repeat bg-cover ">
