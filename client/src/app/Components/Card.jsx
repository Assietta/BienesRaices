...
function Card({ id, address, bathroom_amount, operations,parking_lot_amount, photos, real_address,room_amount, suite_amount,total_surface, type}) {
          ...
          <a href="#" className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
            ...
            <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
              ...
              <div className="flex bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow">
                ...
                {suite_amount} + {suite_amount - room_amount}
                </p>
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
              ...
              <span className="mt-2 xl:mt-0">
                ${operations.prices.price}+{operations.prices.currency}
              </span>
              </p>
            </div>
