...
import { Cama } from './svg'

const Card = (props) => {
  const { id, address, bathrooms, Image, suite_amount,
    room_amount, parking_lot_amount, bathroom_amount } = props;
  return (
    <>
      <div className={styles.card}>
        <div className=" flex justify-center bottom-0 mb-3">
        <div class="flex bg-white px-4 py-1 space-x-5 rounded-lg  shadow">
